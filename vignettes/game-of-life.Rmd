...
#
# @param mouse_x,mouse_y the current positino of the mouse in 'npc' coordinates
#        which span the range [0,1]
# @param frame_num Integer value starting with 1 and incrementing for every
#        frame rendered
# @param fps_actual the current actual framerate
# @param fps_target the target framerate set by the user
# @param dev_width,dev_height size of the device in pixels
# @param ... any other parameters ignored
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
