...
The computer is silly and just picks a move at random.

A great first project (and pull request) would be to make an optimal 
decision engine for the computer.
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
eventloop::run_loop(tictactoe, fps_target = 10, show_fps = TRUE)
```
