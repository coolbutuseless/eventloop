...
fov <- 45
angle_deg <- angle_start + seq(-fov/2, fov/2, length.out = 100)
...
# Draw the walls
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
dists2 <- dists * cos(seq(-fov/2, fov/2, length.out = Nangs) * pi/180)
fill <- c('#004588', '#002366')[types]
grid.rect(x = (((Nangs:1)-0.5)/Nangs), width = 1/Nangs, height = (N - dists2)/15, gp = gpar(col=NA, fill=fill))
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Intersections with horizontal and vertical boundaries
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# if (length(horx) > 0) {
...
# Actual Rays
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
xh <- x0 + dists * cos(theta_orig)
yh <- y0 + dists * sin(theta_orig)
grid.polyline(c(rbind(x0, xh)), c(rbind(y0, yh)), default.units = dunit,
           gp = gpar(col = 'darkgreen', lwd = 1, alpha = 0.5), id = rep(seq(Nangs), each = 2))
